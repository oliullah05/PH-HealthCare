    ...
    return (
        <Container sx={{
            ...
            <Box sx={{
                ...
                <Typography variant="h6" component="p" fontWeight={200} >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos provident tenetur expedita repudiandae possimus quo dolore incidunt, cum eius inventore.</Typography>
                <Box sx={{
                    display: "flex",
                    gap: "7px",
                    marginTop: "10px",
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box mt={4}><Image src={assets.images.doctor1} alt="doctor1" width={240} height={380}></Image></Box>
                    <Box><Image src={assets.images.doctor2} alt="doctor2" width={240} height={350}></Image></Box>
                </Box>
